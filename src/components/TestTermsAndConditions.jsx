  ...
  return (
    <div className={classes.root}>
      ...
      <p>
        ...
        conditions in full. Do not continue to use (Store Name)’s website if you
      ...
      <p>
        ...
        <strong>Ourselves</strong>, <strong>We</strong>, <strong>Our</strong>{' '}
      ...
      <p>
        ...
        consent to the use of cookies in accordance with (Store Name)’s privacy
