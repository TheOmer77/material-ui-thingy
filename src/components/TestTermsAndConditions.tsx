...
const TestTermsAndConditions = () => (
  ...
  >
    <p>
      Welcome to (Store Name) These terms and conditions outline the rules and
      regulations for the use of (Store Name)’s Website.
    </p>
    <p>
      <strong>(Store Name) is located at: , (Address).</strong>
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use (Store Name)’s website if you do not
    ...
    <p>
      ...
      <strong>Client</strong>, <strong>You</strong> and <strong>Your</strong>{' '}
      ...
      <strong>Ourselves</strong>, <strong>We</strong>, <strong>Our</strong> and{' '}
      <strong>Us</strong>, refers to our Company. <strong>Party</strong>,{' '}
      <strong>Parties</strong>, or <strong>Us</strong>, refers to both the
    ...
    <p>
      ...
      accordance with and subject to, prevailing law of (Address).
    </p>
    <p>
    ...
    <p>
      We employ the use of cookies. By using (Store Name)’s website you consent
      to the use of cookies in accordance with (Store Name)’s privacy policy.
      Most of the modern day interactive websites use cookies to enable us to
      retrieve user details for each visit.
    </p>
    <p>
      Cookies are used in some areas of our site to enable the functionality of
      this area and ease of use for those people visiting. Some of our affiliate
    ...
    <p>
      ...
      pages from (Add URL) for your own personal use subject to restrictions set
    ...
    <ul>
      ...
      <li>
        Redistribute content from (Store Name) (unless content is specifically
    ...
    <ol>
      ...
      <li>
        ...
        the subject matter of this disclaimer, including liabilities that arise
        in contract, tort (including negligence) and for breach of statutory
        duty.
      </li>
    </ol>
    <p>
